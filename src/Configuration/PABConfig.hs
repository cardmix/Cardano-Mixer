...
import Wallet.Emulator.Wallet        (Wallet(..), fromBase16, knownWallets)
...
-- -- TODO: add to config
-- mixTokenPolicyId :: [Integer]
-- mixTokenPolicyId = [22,53,190,204,76,102,64,163,201,190,174,197,5,125,196,95,24,108,41,171,95,120,5,170,18,47,79,144]
...
inSimulation :: Bool
inSimulation = pabWallet `elem` knownWallets
